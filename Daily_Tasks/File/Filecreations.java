...
public class Filecreations {
    public static void main(String[] args) {
        ...
        System.out.println("2. Create a folder with 3 files");
        System.out.println("3. Create a folder with 4 files");
        ...
        if (choice == 1) {
            ...
            createDirectoryWithFiles("3filesInIt", 3);
        } else if (choice == 3) {
            createDirectoryWithFiles("4filesInit", 4);
        } else {
